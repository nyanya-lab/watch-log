...
style.css       678줄  커스텀 CSS (Tailwind CDN 위에 얹음)
core.js         853줄  동기화(REST), 상태(State), 탭, Escape, 유틸
tmdb.js         700줄  TMDB 검색/상세/OTT/추천·발굴/컬렉션 캐시
watchlog.js    2221줄  카드 목록, 필터, 등록·수정 모달, 별점 몰아넣기, 설정 탭
...
- [ ] watchlog.js가 2200줄 (카드·필터·모달·설정이 한 파일). 쪼개면 편해지지만 구조 변경이라 확인 필요.
